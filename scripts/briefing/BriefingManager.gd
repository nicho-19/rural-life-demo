...
func compose(day: int, weather_text: String, order_text: String, milestone_text: String, animal_text: String = "", season_text: String = "", crafting_text: String = "", npc_text: String = "") -> String:
