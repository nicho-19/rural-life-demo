...
func compose(day: int, weather_text: String, order_text: String, milestone_text: String, animal_text: String = "", season_text: String = "", crafting_text: String = "", npc_text: String = "", apiary_text: String = "") -> String:
	...
	if not crafting_text.strip_edges().is_empty():
		lines.append(crafting_text)
	if not npc_text.strip_edges().is_empty():
		lines.append(npc_text)
	if not apiary_text.strip_edges().is_empty():
		lines.append(apiary_text)
